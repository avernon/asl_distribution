...
public class ConfigServiceImpl extends ServiceCommonImpl implements ConfigService
{
	...
	public void startConfigServer(
			...
			PassphraseChangedListener passphraseChangeListener, BusAttachment bus
			) throws Exception
	{
		setBus(bus);
		super.startServer();
	...
	/**
	 * The AllJoyn BusObject that exposes the Config Interface of this device over the Bus.
	...
	public List<BusObjectDescription> getBusObjectDescriptions() 
	{
		...
		ajAboutBusObjectDescription.setPath(ConfigTransport.OBJ_PATH);
		ajAboutBusObjectDescription.setInterfaces(new String[]{ConfigTransport.INTERFACE_NAME});
